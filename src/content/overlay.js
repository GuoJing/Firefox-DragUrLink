var DragUrLink =
{
    ...
    OnMainLoad: function()
    {
        DragUrLink.pref = new ___.PrefImpl();
        ...
        getBrowser().setAttribute('ondragend', 'DragUrLink.GoToPage(event,\'no\')');
        getBrowser().setAttribute('ondragstart', 'DragUrLink.StartDrag(event,\'no\')');
        getBrowser().setAttribute('ondragover', 'DragUrLink.StartDrag(event,\'no\')');
        getBrowser().setAttribute('ondrop', 'DragUrLink.StartDrag(event,\'no\')');
        getBrowser().setAttribute('onmousedown', 'DragUrLink.StartDrag(event,\'down\')');
        getBrowser().setAttribute('onmouseup', 'DragUrLink.StartDrag(event,\'up\')');
    },
