const APP_DISPLAY_NAME = "DragUrLink";
const APP_NAME = "DragUrLink";
const APP_PACKAGE = "/informaction/DragUrLink";
const APP_VERSION = "0.9";

const APP_PREFS_FILE="defaults/preferences/foxbeansdef.js";
const APP_XPCOM_SERVICE=null;
const APP_JAR_FILE = "DragUrLink.jar";
...
function myPerformInstall(secondTry) {
  ...
  var chromef = instToProfile ? getFolder("Profile", "extensions/DragUrLink@mozilla.org/chrome") : getFolder("chrome");
